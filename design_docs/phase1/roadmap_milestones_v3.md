...
- `M4`：已完成（Telegram 第二渠道适配）。
- 当前阶段判断：`M4` 已完成；`M5` 仍保持触发式进入，待根据稳定性、恢复风险与维护成本决定是否启动。
...
| v3.7 | 2026-03-03 | 同步 M4 完成状态；将 M5 产品口径细化为启动自检、运行诊断、恢复路径与数据恢复闭环 | M4 closure + M5 scope clarification |
